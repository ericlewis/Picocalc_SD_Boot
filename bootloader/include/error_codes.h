...
typedef enum {
    ...
    ERR_UF2_WRONG_FAMILY = 29,
    ERR_UF2_TOO_LARGE = 30,
    ...
    ERR_FILE_NOT_FOUND = 106,
    ERR_FILE_READ_ERROR = 107,
    
    // Bootloader update errors (121-140)
    ERR_BOOTLOADER_NOT_FOUND = 121,
    ERR_BOOTLOADER_UPDATE_INVALID = 122,
    ERR_BOOTLOADER_UPDATE_WRONG_PLATFORM = 123,
    ERR_BOOTLOADER_UPDATE_TOO_LARGE = 124,
    ERR_BOOTLOADER_UPDATE_CRC_FAIL = 125,
    ERR_BOOTLOADER_UPDATE_VERSION_MISMATCH = 126,
